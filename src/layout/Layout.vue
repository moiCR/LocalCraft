    ...
    <div class="flex flex-col h-screen w-full">
        ...
        <Sidebar :isOpen="isOpen" :toggleSidebar="toggleSidebar">
            <div class="flex flex-col gap-1">
                ...
                <SidebarItem title="Home" :icon="HomeIcon" to="home" :active="route.path.includes('home')" :isOpen="isOpen" />
                <SidebarItem title="Servers" :icon="Server" to="servers" :active="route.path.includes('servers')" :isOpen="isOpen" />
            </div>
            ...
            <div class="flex flex-col gap-1 mt-6">
                ...
                <SidebarItem title="Java Environments" :icon="Coffee" to="java" :active="route.path.includes('java')" :isOpen="isOpen" />
            ...
            <div class="flex flex-col gap-1 mt-6">
                ...
                <SidebarItem title="About" :icon="Info" to="about" :active="route.path.includes('about')" :isOpen="isOpen" />
            </div>
        </Sidebar>

        <main class="flex-1 overflow-y-auto px-24 py-12 w-[calc(100%-256px)] text-black dark:text-white overflow-x-hidden">
            <RouterView />
        </main>
    </div>
    </div>
