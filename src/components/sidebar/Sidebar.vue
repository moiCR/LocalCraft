...
<template>
    ...
    >
        <header
            class="p-4 flex items-center h-18 border-b border-[#242424] overflow-hidden whitespace-nowrap transition-all duration-300"
            :class="props.isOpen ? 'justify-start' : 'justify-center'"
        >
            <button
                @click="toggleSidebar()"
            ...
            >
                <Transition
                    ...
                    :css="false"
                >
                    <LogoIcon class="w-10 h-10" v-show="props.isOpen" />
                </Transition>
